package com.example.socialmedia.b.repositories.profile.jpa.model;
...
public class ProfileJpaModel {
    ...
    @JoinTable(name = "profile_follow", joinColumns = @JoinColumn(name="follower_id", referencedColumnName = "id"),
    ...
    @OneToMany(targetEntity = TweetJpaModel.class, cascade = CascadeType.REMOVE, fetch = FetchType.LAZY, mappedBy = "id")
